...
import uition from "../assets/uition.png";
      ...
      <div className="drawer-side is-drawer-close:overflow-visible">
        ...
        <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-0 is-drawer-open:w-64">
          ...
          <ul className="menu w-full grow">
            ...
            <li>
              <Link
                className="is-drawer-close:hidden bg-base-300 is-drawer-close:tooltip-right mb-5"
                to="/"
              >
                <img src={logoImg} alt="" />
              </Link>
            ...
            {/* all user */}
            {
              <div className="is-drawer-close:hidden is-drawer-close:tooltip-right mb-5 shadow-2xl shadow-secondary rounded-2xl m-3 p-2">
                <img
                  className="w-30 h-30 mx-auto rounded-full overflow-hidden border border-secondary my-5"
                  src={
                    userData?.photoURL ||
                    "https://i.ibb.co.com/kgMj4c4G/pngtree-user-icon-isolated-on-abstract-background-png-image-5192160.jpg"
                  }
                  alt="Avater"
                />
                ...
                <p className="text-center mx-auto font-extrabold">
                  ID: {userData?.userId}
                </p>
